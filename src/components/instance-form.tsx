            ...
            />
             <FormField
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input id="webhookUrl" {...field} className="bg-[#2a3942] border-none" placeholder="Cole a URL do ngrok aqui" />
                  </FormControl>
                   <p className="text-xs text-gray-500">Use a URL pública (ngrok) para receber mensagens.</p>
                  <FormMessage />
                </FormItem>
              )}
            />
